...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEditorProperties_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEditorProperties_KeyDown, "KeyDown" }, // 2740068462
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEditorProperties_Statics::NewProp_ShortcutKey = { "ShortcutKey", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEditorProperties, ShortcutKey), Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(Z_Construct_UClass_UEditorProperties_Statics::NewProp_ShortcutKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEditorProperties_Statics::NewProp_ShortcutKey_MetaData)) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UEditorProperties_Statics::NewProp_SetLanguage = { "SetLanguage", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEditorProperties, SetLanguage), Z_Construct_UEnum_ShortcutKeysToSwitchLanguages_ESetLanguage, METADATA_PARAMS(Z_Construct_UClass_UEditorProperties_Statics::NewProp_SetLanguage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEditorProperties_Statics::NewProp_SetLanguage_MetaData)) }; // 1455020776
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ShortcutKeysToSwitchLanguages_Source_ShortcutKeysToSwitchLanguages_Public_EditorProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEditorProperties, UEditorProperties::StaticClass, TEXT("UEditorProperties"), &Z_Registration_Info_UClass_UEditorProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorProperties), 3638332263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ShortcutKeysToSwitchLanguages_Source_ShortcutKeysToSwitchLanguages_Public_EditorProperties_h_3966145111(TEXT("/Script/ShortcutKeysToSwitchLanguages"),
